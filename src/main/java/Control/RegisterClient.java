    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(client.getId() == 0){
            ...
            if(clientDAO.registerClient(client)){
                ...
                text.append("<div style=\"margin: 0; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; width: 600px; height: 600px; background-image: url('http://www.mirandataxi.com.br/conf-cad.jpg');\">\n" +
                            ...
                            "<a style=\"font-size: 12px;\" href='http://www.mirandataxi.com.br/mirandataxiapp/'>CLIQUE AQUI</a></td></tr>\n" +
