        ...
        if(client.getId() == 0){
            ...
            if(clientDAO.registerClient(client)){
                ...
                text.append("<div style=\"margin: 0; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; width: 600px; height: 600px; background-image: url('https://mirandataxi.com.br/img/background/conf-cad.jpg');\">\n" +
                            ...
                            "<h1 style=\"margin: 0; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; font-weight: bold; font-size: 25px; color: #ffffff; margin-top: 255px; background-color: #000000;\">CONTATOS</h1></td></tr>\n" +
                            ...
                            "<td style=\"border-left: 1px solid white; text-align: left; padding-left: 2%;  background-color: #000000;\"><h3 style=\"margin: 0; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; font-weight: regular; font-size: 8px; float: left; color: #ffffff;\">SIGA-NOS NAS <br> REDES SOCIAIS</h3>\n" +
