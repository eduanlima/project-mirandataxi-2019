...
public class RecoverPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(client.getId()!= 0){
            ...
            text.append("<div style=\"margin: 0; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; position: relative; width: 600px; height: 590px; background-image: url('http://www.mirandataxi.com.br/rec-senha.jpg');\">\n" +
                        ...
                        "<tr style=\"height: 100px;\"><td style=\"width: 100px; background-image: url('http://www.mirandataxi.com.br/icon-key.png'); background-repeat: no-repeat;\"><td/> <td style=\"width: 185px;\"><h2 style=\"margin: 0; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; font-weight: bold; font-size: 55px; margin-top: 8px; color: #000000;\">"+newpass+"<h2/><td/></tr></table>\n" +
                        ...
                        "<a href='http://www.mirandataxi.com.br/mirandataxiapp/'>CLIQUE AQUI</a></div>\n" +
