 ...
 * @author eduan
 */
@WebServlet(name = "CancelRunningDriver", urlPatterns = {"/CancelRunningDriver"})
public class CancelRunningDriver extends HttpServlet {
     ...
     * @throws com.mercadopago.exceptions.MPException
     */
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int statusCancel =  Integer.parseInt(request.getParameter("situacao"));
        ...
        if(paymentMain.getStatus().equals("approved")){
                ...
                if(statusCancel == 0){
                    ...
                    //partially_refunded
                    messageClient = "ATENÇÃO: O serviço foi cancelado pelo modorista de acordo com a solicitação<br>do cliente, dentro do período de 24h que antecediam sua execução,<br>assim sendo, de acordo com os termos de uso do serviço, o valor devolvido ao<br>cartão de crédito será igual à 50% do valor total do serviço.";
                    messageDriver = "Valor parcial devolvido ao cliente. Cancelamento efetuado por motorista.";
                
                }else if(statusCancel == 1){
                    paymentMain.refundPayment(paymentMain.getId());
                    messageClient = "ATENÇÃO: O valor da compra do serviço será totalmente<br>devolvido ao cartão de crédito. Cancelamento efetuado pelo motorista.";
                    messageDriver = "Valor total devolvido ao cliente. Cancelamento efetuado pelo motorista.";
                }
        }else{
                paymentMain.cancelPayment(paymentMain.getId());
                messageClient = "Serviço cancelado. Cancelamento efetuado pelo motorista.";
                messageDriver = "O pagamento ainda não havia sido aprovado. Cancelamento efetuado pelo motorista.";
        }
        ...
        try{
            ...
            text.append("<div style=\"margin: 0; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; position: relative; width: 600px; height: 590px; background-image: url('http://www.mirandataxi.com.br/rec-senha.jpg'); background-repeat: no-repeat;\">\n" +
            ...
            " <tr><th colspan=\"2\"><h1 style=\"margin: 0;padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; font-weight: bold; font-size: 20px; color: #000000;  margin-top: 145px; \">"+client.getName() +
            ...
            " <table style=\"margin: 0; padding: 0; border: 0; font-size: 100%; font: inherit; vertical-align: baseline; border-collapse: collapse; border-spacing: 0; width: 200px; margin-left: 20px; text-align: right; font-family: 'Arial', 'Calibri'; color: #ffffff; display: block;\">\n" +
            ...
            " <tr><td colspan=\"2\"><a href=\"https://api.whatsapp.com/send?phone=5511998965109\" style=\"float: right; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; font-weight: regular; font-size: 85%; color: #ffffff;\">(11) 99896-5109</a><img src=\"http://www.mirandataxi.com.br/icon-whats-email.png\" style=\"margin-right: 3px; display: inline-block; float: right; padding: 0; border: 0; font-size: 0px; font: inherit; vertical-align: baseline; position: relative; width: 16px; height: 16px;\"></img></td></tr>\n" +
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CancelRunningDriver.class.getName()).log(Level.SEVERE, null, ex);
